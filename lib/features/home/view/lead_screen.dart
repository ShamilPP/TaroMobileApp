...
class _LeadsViewState extends State<LeadsView> with RouteAware {
  ...
  String userInitials =
      ''; // UNIFIED FILTER STATE - Replace LeadFilterState with UnifiedFilterState
  ...
  bool _hasActiveFilters() {
    return (filterState.selectedPropertyType != 'All' &&
            filterState.selectedPropertyType.isNotEmpty) ||
        (filterState.selectedBHK != 'All' &&
            filterState.selectedBHK.isNotEmpty) ||
        (filterState.selectedFurnishingStatus != 'All' &&
            filterState.selectedFurnishingStatus.isNotEmpty) ||
  ...
  Widget build(BuildContext context) {
    return Consumer<LeadProvider>(
      builder: (context, leadProvider, child) {
        final closedDealsCount = _getClosedDealsCount(leadProvider);
              ...
              slivers: [
                SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      // Always show the green header
                      _buildUserHeader(context, leadProvider),

                      // Search and filter section
                      // _buildHeaderWithSearch(leadProvider),

                      // White background container for category filters
                      Container(
                        color: Colors.white,
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              // Conditionally show category filters
                              if (!_hasActiveFilters()) ...[
                                // Category filters
                                Row(
                                  children: [
                                    _buildAllTypeFilters(),
                                    SizedBox(width: 12),
                                    _buildPropertyForFilters(),
                                  ],
                                ),
                              ],

                              // Error handling (always show if there's an error)
                              if (leadProvider.error.isNotEmpty)
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: leadProvider.clearError,
                                        icon: Icon(
                                          Icons.close,
                                          color: Colors.red.shade600,
                                          size: 18,
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate((context, index) {
                        return _buildLeadCard(leadProvider.leads[index]);
                      }, childCount: leadProvider.leads.length),
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(child: _buildSearchField(leadProvider)),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            ...
            colors: [AppColors.taroGrey, AppColors.taroGrey],
          ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Row(
                    ...
                    children: [
                      Text(
                        "Closing deals like it's a sport ",
                        style: TextStyle(
                          fontSize: 12,
  ...
  Widget _buildActiveFilterChips() {
    ...
    if (filterState.selectedLeadType != 'All' &&
        filterState.selectedLeadType.isNotEmpty) {
      filterChips.add(
        _buildFilterChip(
    ...
    // Property For filter
    if (filterState.selectedPropertyFor != 'All' &&
        filterState.selectedPropertyFor.isNotEmpty) {
      filterChips.add(
        _buildFilterChip(
    ...
    // BHK filter
    if (filterState.selectedBHK != 'All' &&
        filterState.selectedBHK.isNotEmpty) {
      filterChips.add(
        _buildFilterChip(
    ...
    if (filterState.selectedFurnishingStatus != 'All' &&
        filterState.selectedFurnishingStatus.isNotEmpty) {
      filterChips.add(
        _buildFilterChip(
    ...
    if (filterState.minPrice.isNotEmpty || filterState.maxPrice.isNotEmpty) {
      ...
      if (filterState.minPrice.isNotEmpty && filterState.maxPrice.isNotEmpty) {
        priceLabel =
            '${_formatPriceForChip(filterState.minPrice)} - ${_formatPriceForChip(filterState.maxPrice)}';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(spacing: 8, runSpacing: 6, children: filterChips),
        ],
      ),
    );
  }
    ...
    try {
      ...
      if (leads.isEmpty) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('No leads data to export'),
      ...
      final fileName =
          'leads_export_${DateTime.now().toIso8601String().replaceAll(':', '-')}.csv';
  ...
  Future<void> _saveFileAndroid15Compatible(
    String csvContent,
    String fileName,
    int leadCount,
  ) async {
  ...
  Future<bool> _tryMediaStoreDownload(
    String csvContent,
    String fileName,
    int leadCount,
  ) async {
  ...
  Future<void> _shareFile(
    ...
    try {
      ...
      await Share.shareXFiles(
        [XFile(filePath)],
        text: 'Leads Export CSV - $leadCount leads exported',
        subject: 'Leads Export',
      );
      _showSuccessMessage(
        "File ready to save - choose your preferred location",
        leadCount,
      );
    } catch (e) {
          ...
          (context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text(
                  'The file is saved in the app\'s private storage. You can share it using the button below.',
                  style: TextStyle(fontSize: 12, color: Colors.grey[600]),
                ),
              ],
            ),
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  try {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text('Unable to share file: $e'),
                        behavior: SnackBarBehavior.floating,
                      ),
                    );
                  }
  ...
  Future<String> _generateCSVContent(List<LeadModel> leads) async {
    ...
    for (LeadModel lead in leads) {
      ...
      Map<String, dynamic> propertyInfo = await _getPropertyInfoForCSV(
        lead.id ?? '',
      );
  ...
  Future<Map<String, dynamic>> _getPropertyInfoForCSV(String leadId) async {
    ...
    try {
      ...
      for (QueryDocumentSnapshot doc in residentialSnapshot.docs) {
        ...
        ResidentialProperty property = ResidentialProperty.fromMap(
          data,
          doc.id,
        );
  ...
  Widget _buildCategoryButtonWithDoubleClick(
    String label, {
    bool isActive = false,
    VoidCallback? onTap,
  }) {
      ...
      child: Container(
        ...
        child: Center(
          child: Text(
            label,
            style: TextStyle(
              color: isActive ? Colors.white : AppColors.taroBlack,
              fontWeight: FontWeight.w500,
              fontSize: 11,
            ),
          ),
  ...
  void _showFilterBottomSheet(BuildContext context) {
    ...
    List<String> availableTenantPreferences = _getAvailableTenantPreferences(
      leadProvider,
    );
    ...
    UnifiedFilterState currentFilterState =
        UnifiedFilterState()
          ...
          ..selectedTenantPreferences = List.from(
            leadProvider.selectedTenantPreferences,
          )
          ..minPrice = leadProvider.minPrice
          ..maxPrice = leadProvider.maxPrice
          ..useSliderBudget =
              false // Default to chips
          ..minBudgetSlider = _getMinSliderValue(
            leadProvider.selectedPropertyFor,
          )
          ..maxBudgetSlider = _getMaxSliderValue(
            leadProvider.selectedPropertyFor,
          );
      ...
      onApplyFilters: (UnifiedFilterState newFilterState) {
        ...
        setState(() {
          ...
          filterState.selectedTransactionType =
              newFilterState.selectedTransactionType;
          filterState.selectedPropertyType =
              newFilterState.selectedPropertyType;
          filterState.selectedBHK = newFilterState.selectedBHK;
          filterState.selectedFurnishingStatus =
              newFilterState.selectedFurnishingStatus;
          filterState.selectedStatuses = List.from(
            newFilterState.selectedStatuses,
          );
          filterState.selectedSubtypes = List.from(
            newFilterState.selectedSubtypes,
          );
          filterState.selectedLocations = List.from(
            newFilterState.selectedLocations,
          );
          filterState.selectedBudgetRanges = List.from(
            newFilterState.selectedBudgetRanges,
          );
          filterState.selectedTenantPreferences = List.from(
            newFilterState.selectedTenantPreferences,
          );
  ...
  void _applyFiltersToProvider(
    UnifiedFilterState newFilterState,
    ...
    leadProvider.setFurnishingStatusFilter(
      newFilterState.selectedFurnishingStatus,
    );
    ...
    leadProvider.setTenantPreferencesFilter(
      newFilterState.selectedTenantPreferences,
    );
    ...
    if (newFilterState.useSliderBudget) {
      ...
      print(
        '🔧 Applied slider budget: ₹${newFilterState.minBudgetSlider} - ₹${newFilterState.maxBudgetSlider}',
      );
    } else {
      ...
      if (newFilterState.selectedBudgetRanges.isNotEmpty) {
        ...
        print(
          '🔧 Applied budget range chips: ${newFilterState.selectedBudgetRanges}',
        );
      } else {
        leadProvider.clearBudgetFilters();
      }
      ...
      if (newFilterState.minPrice.isNotEmpty ||
          newFilterState.maxPrice.isNotEmpty) {
        leadProvider.setBudgetRange(
          newFilterState.minPrice,
          newFilterState.maxPrice,
        );
        print(
          '🔧 Applied text budget range: "${newFilterState.minPrice}" - "${newFilterState.maxPrice}"',
        );
      }
    }
  ...
  int _getActiveFilterCount() {
    ...
    if (filterState.minPrice.isNotEmpty || filterState.maxPrice.isNotEmpty)
      count++;
    if (filterState.useSliderBudget &&
        (filterState.minBudgetSlider > 0 || filterState.maxBudgetSlider < 500))
      count++;
  ...
  Stream<List<BaseProperty>> getFilteredPropertiesForLead(String leadId) {
    ...
    if (filterState.selectedPropertyType == 'All' ||
        filterState.selectedPropertyType == 'Residential') {
      propertyStreams.add(
        _buildPropertyStream(
          'Residential',
          leadId,
          propertyForFilter,
          (data, id) => ResidentialProperty.fromMap(data, id),
        ),
      );
    }

    if (filterState.selectedPropertyType == 'All' ||
        filterState.selectedPropertyType == 'Commercial') {
      propertyStreams.add(
        _buildPropertyStream(
          'Commercial',
          leadId,
          propertyForFilter,
          (data, id) => CommercialProperty.fromMap(data, id),
        ),
      );
    }

    if (filterState.selectedPropertyType == 'All' ||
        filterState.selectedPropertyType == 'Plots') {
      propertyStreams.add(
        _buildPropertyStream(
          'Plots',
          leadId,
          propertyForFilter,
          (data, id) => LandProperty.fromMap(data, id),
        ),
      );
    }
  ...
  Stream<List<BaseProperty>> _buildPropertyStream(
    String collection,
    String leadId,
    String? propertyFor,
    BaseProperty Function(Map<String, dynamic>, String) fromMap,
  ) {
    ...
    return query.snapshots().map((snapshot) {
      final list =
          snapshot.docs
              .map((doc) {
                print(
                  'Found $collection Property: ${doc.id} for leadId: $leadId',
                );
          ...
          onTap: () {
            if (isSelectionMode) {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => PropertyDetailsDisplayScreen(lead: lead),
                ),
              );
            }
          },
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color:
                            isSelected
                                ? Colors.red
                                : _getColorForPropertyFor(
                                  properties.isNotEmpty
                                      ? properties.first.propertyFor
                                      : null,
                                ),
                      ),
                    ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            Stack(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color:
                                        AvatarColorUtils.getAvatarColorFromLead(
                                          lead,
                                        ),
                                    shape: BoxShape.circle,
                                  ),
                        ...
                        Transform.translate(
                          offset: const Offset(0, -15),
                          child: _buildNewLeadPropertyInfo(properties, lead),
                        ),
                      ],
                    ),
                  ),
        ...
        child: Row(
          children: [
            ...
            TextButton(
              ...
              child: Text(
                'Cancel',
                style: AppFonts.interDefault.copyWith(
                  fontSize: 14,
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  'DELETE',
                  style: AppFonts.interSemiBold.copyWith(fontSize: 14),
                ),
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          title: Text(
            'Delete Leads',
            style: AppFonts.interBold.copyWith(fontSize: 18),
            textAlign: TextAlign.center,
          ),
          content: Text(
          ...
          actions: [
            ...
            TextButton(
              ...
              child: Text(
                'Delete',
                style: AppFonts.interSemiBold.copyWith(color: Colors.red),
              ),
            ),
          ],
        );
        ...
        SnackBar(
          content: Row(
            children: [
              ...
              SizedBox(width: 12),
              Text(
                'Deleting $selectedCount lead${selectedCount > 1 ? 's' : ''}...',
                style: AppFonts.interDefault.copyWith(color: Colors.white),
              ),
            ],
          ),
          ...
          SnackBar(
            content: Row(
              children: [
                ...
                SizedBox(width: 12),
                Text(
                  '$selectedCount lead${selectedCount > 1 ? 's' : ''} deleted successfully',
                  style: AppFonts.interDefault.copyWith(color: Colors.white),
                ),
              ],
            ),
  ...
  void _showStatusMenu(BuildContext context, LeadModel lead) {
        ...
        statuses.map((status) {
          return PopupMenuItem(
            ...
            child: Center(
              child: Text(
                status,
                style: AppFonts.interDefault.copyWith(fontSize: 12),
              ),
            ),
          );
        }).toList();
    ...
    showMenu<String>(
      ...
      color: Colors.white,
      items: menuItems,
    ).then((String? selectedValue) async {
      if (selectedValue != null && context.mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Updating status to $selectedValue...',
              style: AppFonts.interDefault,
            ),
  ...
  Widget _buildNewLeadPropertyInfo(
    ...
    return Column(
      ...
      children: [
        ...
        if (primaryProperty is ResidentialProperty)
          _buildCompactResidentialDetails(primaryProperty, lead),
        if (primaryProperty is CommercialProperty)
          _buildCompactCommercialDetails(primaryProperty),
        if (primaryProperty is LandProperty)
          _buildCompactLandDetails(primaryProperty),
        ...
        if (primaryProperty.askingPrice?.isNotEmpty == true)
          Row(
            children: [
              Text(
                _formatPriceForNewCard(
                      primaryProperty.askingPrice,
                      primaryProperty.propertyFor,
                    ) +
                    (primaryProperty.propertyFor?.toLowerCase() == 'rent'
                        ? ' /month${_hasDeposit(primaryProperty) ? '*' : ''}'
                        : primaryProperty.propertyFor?.toLowerCase() ==
                                'lease' &&
                            primaryProperty.leadDuration?.isNotEmpty == true
              ...
              if (primaryProperty.propertyFor?.toLowerCase() == 'rent') ...[
                ...
                if (_hasMaintenance(primaryProperty)) ...[
                  const SizedBox(width: 8),
                  Text(
                    _getMaintenanceText(primaryProperty),
                    style: propertyTextStyle.copyWith(
                      fontWeight: FontWeight.w500,
                    ),
                    maxLines: 1,
  ...
  bool _hasMaintenance(BaseProperty property) {
    if (property is ResidentialProperty) {
      return property.maintenance?.isNotEmpty == true &&
  ...
  String _getMaintenanceText(BaseProperty property) {
    if (property is ResidentialProperty &&
        property.maintenance?.isNotEmpty == true &&
        property.maintenance != '0') {
  ...
  String _getDepositText(BaseProperty property) {
    if (property is ResidentialProperty &&
        property.deposit?.isNotEmpty == true &&
        property.deposit != '0') {
      ...
      child: Row(
        children:
            tags
                .map(
                  (tag) =>
                      Padding(padding: EdgeInsets.only(right: 8), child: tag),
                )
                .toList(),
      ),
    );
  ...
  Future _updateLeadStatusInFirestore(
    String newStatus,
    LeadModel lead,
    BuildContext context,
  ) async {
  ...
  String _formatPropertyDetails(List<BaseProperty> properties) {
    ...
    for (BaseProperty property in properties) {
      ...
      if (property is ResidentialProperty) {
        ...
        } else if (property.cents != null &&
            property.cents.toString().isNotEmpty) {
          areaWithUnit = '${property.cents} cents';
        } else if (property.squareFeet != null &&
            property.squareFeet.toString().isNotEmpty) {
          areaWithUnit = '${property.squareFeet} sq ft';
        } else if (property.acres != null &&
            property.acres.toString().isNotEmpty) {
  ...
  String _getFurnishingText(ResidentialProperty property) {
    ...
    if (property.unfurnished == true)
      return '          🪑: Unfurnished'; // ✅ Fixed: unfurnished not preferUnfurnished
    if (property.semiFinished == true)
      return '          🪑: Semi-Furnished'; // ✅ Fixed: semiFinished not preferSemiFurnished
    return '';
  }

  Widget _buildCompactResidentialDetails(
    ...
    if (lead.leadType == 'Tenant') {
      ...
      return Column(
        ...
        children: [
          ...
          Text(
            [
              property.selectedBHK?.isNotEmpty == true
                  ? '🏠: ${property.selectedBHK}'
                  : null,
              property.propertySubType?.isNotEmpty == true
                  ? property.propertySubType
                  : null,
              _getFurnishingText(property).isNotEmpty
                  ? _getFurnishingText(property)
                  : null,
  ...
  String _getLeaseDurationText(BaseProperty property) {
    if (property.propertyFor?.toLowerCase() == 'lease' &&
        property.leadDuration?.isNotEmpty == true) {
      String duration = property.leadDuration!;

      String convertedDuration = duration
          .toLowerCase()
          .replaceAll('/month', '/m')
          .replaceAll('/year', '/y');
  ...
  Widget _buildCompactLandDetails(LandProperty property) {
    ...
    return Column(
      ...
      children: [
        if (property.propertySubType?.isNotEmpty == true) ...[
          Text(
            '🏞️: ${property.propertySubType} Plot',
            style: propertyTextStyle,
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
          ),
        ...
        if (property.additionalNotes?.isNotEmpty == true)
          Text(
  ...
  bool _shouldShowAreaInfo(LandProperty property) {
    return (property.squareFeet?.isNotEmpty == true &&
  ...
  Widget _buildNeumorphicIcon(String assetPath, VoidCallback onTap) {
    return InkWell(
      ...
      borderRadius: BorderRadius.circular(
        13,
      ), // Half of width/height for circular ripple
      child: Container(
        width: 35,
        height: 35,
        decoration: BoxDecoration(
